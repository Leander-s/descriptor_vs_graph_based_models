...
def main():
    ...
    for i, dataset in enumerate(Datasets):
        ...
        rdkit_df, rdkit_time = get_descriptors(path)
        ...
        minimol_df.to_csv(
            f"../minimol_datasets/{dataset}-minimol_descriptors.csv", index=False)

        rdkit_df.to_csv(f"../rdkit_datasets/{dataset}-rdkit_descriptors.csv", index=False)
